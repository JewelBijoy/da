...
def qq():
    if request.method == "POST":
        ...
        return render_template('index.html', data=data, a=a, v=v, r3=res5, ver=v, freq=resfreq1, c_5=c_5, appr=resappr,
                               appr2=resappr2, freqrisk=resfreqrisk, risky=resrisky, openrisky=resriskyopen,
                               openob=resopen, closedob=resclosed)
